...
class tracker_four_frames(object):
    ...
    def find_best_estimate_link(self, particle):
        ...
        # if (particle[-1] - 2) >= 0:
        #     p_im0 = self.get_particle_by_id(id_, particle[-1]-2)
        #     if p_im0 is not None:
        #         pv = (p_im1[1:4]-p_im0[1:4])/dt
        #         v = (v+pv)/2
        #
        #         if (particle[-1] - 3) >= 0:
        #             p_im_1 = self.get_particle_by_id(id_, particle[-1]-3)
        #             if p_im_1 is not None:
        #                 ppv = (p_im0[1:4]-p_im_1[1:4])/dt
        #                 v = (v+pv+ppv)/3
        #
